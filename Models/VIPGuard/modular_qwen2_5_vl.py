...
from processing_qwen2_vl import Qwen2VLImagesKwargs, Qwen2VLProcessor
...
# NOTE:
class Qwen2_5_FCConfig(PretrainedConfig):
    model_type = "qwen2_5_vl"
    base_config_key = "facechecker_config"
...
# NOTE
class Qwen2_5_FC_Config(Qwen2VLConfig):
    model_type = "qwen2_5_vl"
    sub_configs = {"facechecker_config": Qwen2_5_FCConfig}
...
__all__ = [
    ...
    "Qwen2_5_FaceCheckerPretrainedModel"
    "Qwen2_5_VLProcessor",
]
