...
def get_model_tokenizer(
    ...
    model_info, model_meta = get_model_info_meta_ours(
        model_id_or_path,
        torch_dtype,
        use_hf=use_hf,
        hub_token=hub_token,
    ...
    model = AutoModel.from_pretrained("/data0/linkaiqing/code/MLLM/VIP_DFD_LLM_V4/Model_Stage1_Checkpoints/1")
    processor = AutoProcessor.from_pretrained("/data0/linkaiqing/code/MLLM/VIP_DFD_LLM_V4/Model_Stage1_Checkpoints/1")
