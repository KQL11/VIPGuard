...
class MTCNN(nn.Module):
    ...
    Keyword Arguments:
        image_size {int} -- Output image size in pixels. The image will be square. (default: {160}).
            # NOTE: Now it can receive input 'None' to return the original crop face size.
    ...
    def forward(self, img, landmark=False, save_path=None, return_prob=False):
        ...
        if return_prob and landmark:
            return faces, batch_probs, batch_points
        elif return_prob:
